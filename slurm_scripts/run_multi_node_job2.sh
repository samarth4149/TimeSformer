...
#### Kinetics training
JOB_NAME=MiniKinetics_TimeSformer_divST_8x32_224_pt
python tools/submit.py --cfg configs/MiniKinetics/TimeSformer_divST_8x32_224_pt.yaml --job_dir  expts/${JOB_NAME}/  --num_shards 4 --num_gpus 4 --name ${JOB_NAME}
