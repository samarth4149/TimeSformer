...
python tools/submit.py --cfg configs/MiniKinetics/TimeSformer_divST_8x32_224_pt.yaml --job_dir expts/step3/${JOB_NAME}/ --num_shards 1 --num_gpus 4 --name ${JOB_NAME} DATA.NUM_FRAMES 16 MODEL.MODEL_NAME vit_base_patch16_224 TIMESFORMER.PRETRAINED_MODEL omnimae_vitb_b128_ep200_NB256__dset_mae_k150_config_200.pt TRAIN.BATCH_SIZE 16 TRAIN.DEL_INTERMEDIATE_CHECKPOINTS False TRAIN.CHECKPOINT_PERIOD 5
