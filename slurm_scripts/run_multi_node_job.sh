...
#### Kinetics training
JOB_NAME=MiniMoments_TimeSformer_divST_8x32_224_scratch
python tools/submit.py --cfg configs/MiniMoments/TimeSformer_divST_8x32_224_scratch.yaml --job_dir  expts/${JOB_NAME}/  --num_shards 4 --num_gpus 4 --name ${JOB_NAME}
