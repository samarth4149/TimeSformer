...
python tools/submit.py --cfg configs/MiniKinetics/TimeSformer_divST_8x32_224.yaml --job_dir  expts/${JOB_NAME}/  --num_shards 8 --num_gpus 6 --name ${JOB_NAME} --resume-from expts/MiniKinetics_TimeSformer_divST_8x32_224/checkpoints/checkpoint_epoch_00030.pyth
