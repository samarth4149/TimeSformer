...
do
    ...
    do
        ...
        do
            ...
            # python tools/submit.py --cfg configs/Downstream/${dset}_lin_probe.yaml --job_dir expts/downstream/hp_tune/from_${backbone_dir}/${dset}_linprobe/base_lr_${base_lr_str}  --num_shards 1 --num_gpus 4 --name ${JOB_NAME} DATA.NUM_FRAMES 16 MODEL.MODEL_NAME vit_base_patch16_224 TRAIN.CHECKPOINT_FILE_PATH /gpfs/u/home/DPLD/DPLDsmms/scratch/projects/TimeSformer/expts/step3/${backbone_dir}/checkpoints/checkpoint_epoch_00075.pyth SOLVER.BASE_LR ${base_lr} TRAIN.BATCH_SIZE 32 DATA.PATH_TO_DATA_DIR /gpfs/u/home/DPLD/DPLDhwrg/scratch/TimeSformer/data_files/${dset}_val TIMESFORMER.ST_ADAPTER True TIMESFORMER.ST_ADAPTER_DIM 172;
