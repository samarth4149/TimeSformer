...
do
    ...
    do
        ...
        JOB_NAME=${backbone_dir}_epoch50_${dset}_lin_probe
        python tools/submit.py --cfg configs/Downstream/${dset}_lin_probe.yaml --job_dir  expts/downstream/from_${backbone_dir}/${JOB_NAME}/  --num_shards 1 --num_gpus 4 --name ${JOB_NAME} DATA.NUM_FRAMES 16 MODEL.MODEL_NAME vit_base_patch16_224 TRAIN.CHECKPOINT_FILE_PATH /gpfs/u/home/DPLD/DPLDsmms/scratch/projects/TimeSformer/expts/step3/${backbone_dir}/checkpoints/checkpoint_epoch_00050.pyth TRAIN.BATCH_SIZE 32 SOLVER.BASE_LR 0.01
