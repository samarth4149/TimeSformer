...
def train_epoch(
    ...
    for cur_iter, (inputs, labels, _, meta) in enumerate(train_loader):
        ...
        optimizer.param_groups[-1]['lr'] *= cfg.SOLVER.HEAD_LR_FACTOR
...
def train(cfg):
    ...
    if not cfg.TRAIN.FINETUNE:
      ...
      start_epoch = 0
      cu.load_checkpoint(cfg.TRAIN.CHECKPOINT_FILE_PATH, model, clear_name_pattern=cfg.TRAIN.CHECKPOINT_CLEAR_NAME_PATTERN)
